...
const QUICK_NOTE_ENTITY_TYPES = new Set(['contact', 'lead', 'company', 'proposal']);
type QuickNoteEntityType = 'contact' | 'lead' | 'company' | 'proposal';
      ...
      <nav className="-mb-px flex space-x-4 sm:space-x-8 min-w-max px-1">
        {tabs.map((tab) => (
          <button
            ...
            className={clsx(
              'whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm flex-shrink-0 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500',
              activeTab === tab.id
