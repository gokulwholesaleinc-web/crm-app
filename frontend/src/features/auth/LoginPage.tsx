...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-brand-page py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center mb-4">
              <div>
                <img
                  ...
                  width={64}
                  height={64}
                  className="h-16 w-auto object-contain dark:[filter:drop-shadow(0_0_2px_rgba(255,255,255,0.75))_drop-shadow(0_0_6px_rgba(255,255,255,0.35))]"
