 ...
 *
 * Provides an in-app walkthrough of how each tab in the CRM works and
 * how the core flows (lead → contact → opportunity → quote → payment)
 * connect together. Content is hand-written to match what the codebase
 * actually supports — no fabricated features.
 */
