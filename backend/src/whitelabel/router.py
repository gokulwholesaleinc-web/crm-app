...
def _build_public_tenant_config(tenant: Tenant) -> PublicTenantConfig:
    ...
    return PublicTenantConfig(
        ...
        social_facebook_url=settings.social_facebook_url if settings else None,
        social_instagram_url=settings.social_instagram_url if settings else None,
        social_tiktok_url=settings.social_tiktok_url if settings else None,
