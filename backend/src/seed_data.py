"""Static seed data constants and build-time helpers.

Imported by seed.py — all values are plain Python dicts so no ORM imports are
needed here.  _today() and _dt() are called at module import time (list
