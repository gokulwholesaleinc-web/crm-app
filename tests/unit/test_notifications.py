...
# TestQuoteRejectNotification + TestPublicQuoteRejectNotification removed
# 2026-05-14 — quotes router unmounted; quote.rejected events no longer fire.
...
# TestQuoteSentNotifiesOwner removed 2026-05-14 — quotes router
# unmounted; quote.sent events no longer fire.
