...
# ---------------------------------------------------------------------------
# Opportunity cascade on invoice.paid retired with the Opportunities module
# (PR #328, 2026-05-14). The webhook only flips the proposal status now.
# ---------------------------------------------------------------------------
...
# TestCheckoutFromQuoteOpportunityCascade removed 2026-05-14 — quotes
# router unmounted; create_checkout_session no longer back-fills
# opportunity_id from a linked quote.
